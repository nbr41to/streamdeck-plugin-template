...
function connected(jsn) {
  ...
  $SD.on('com.elgato.my.action.willAppear', (jsonObj) =>
    action.onWillAppear(jsonObj),
  );
  $SD.on('com.elgato.my.action.keyUp', (jsonObj) => action.onKeyUp(jsonObj));
  $SD.on('com.elgato.my.action.sendToPlugin', (jsonObj) =>
    action.onSendToPlugin(jsonObj),
  );
  $SD.on('com.elgato.my.action.didReceiveSettings', (jsonObj) =>
    action.onDidReceiveSettings(jsonObj),
  );
  $SD.on('com.elgato.my.action.propertyInspectorDidAppear', (jsonObj) => {
    console.log(
      '%c%s',
  ...
  $SD.on('com.elgato.my.action.propertyInspectorDidDisappear', (jsonObj) => {
    console.log(
      '%c%s',
